        ...
        <div className="relative z-20 flex-1 flex flex-col justify-end w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20">
          <div className="max-w-4xl">
            ...
            <h1 className="text-[clamp(1.75rem,7vw,4.2rem)] sm:text-[clamp(2.5rem,5vw,4.2rem)] font-[600] leading-[1.08] tracking-[-0.03em] text-[#1C1A16]">
              Espace de travail IA pour la déclaration G50 — <br className="hidden sm:block" />
              readiness, anomalies et relances bilingues.
            </h1>
            <p className="mt-4 text-[15px] sm:text-[16px] text-[#6B6966] max-w-xl leading-relaxed">
              ...
              <div className="self-end bg-[#F4F3EF] rounded-2xl p-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex gap-3 items-start">
                    ...
                    <span className="text-[13px] text-[#1C1A16] font-medium">Skills IA (classify, extract)</span>
                  </div>
                  <div className="flex gap-3 items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
            <FadeIn delay={0.15} direction="left">
              <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm h-full">
                ...
                <h3 className="text-[20px] sm:text-[22px] font-semibold text-[#1C1A16] mb-3">Skills IA — raisonnement ciblé</h3>
                <p className="text-[14px] sm:text-[15px] leading-[1.65] text-[#6B6966]">
                  Quatre skills spécialisées lisent le texte OCR : classification, extraction des champs fiscaux algériens, détection des champs manquants, et rédaction des relances bilingues. Les outils déterministes valident les montants et fixent le statut READY / INCOMPLETE / BLOCKED.
                </p>
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          <FadeIn delay={0.1} direction="none">
            <p className="text-[16px] text-white/70 mb-8 max-w-lg">
              Workflow déclaration : intake → OCR → skills → checks → readiness → relances FR/AR.
            </p>
          </FadeIn>
