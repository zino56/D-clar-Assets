      ...
      <section className="bg-[#F4F3EF] py-16 sm:py-20 lg:py-28 w-full">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7">
            ...
            {/* Card 2 */}
            <div className="bg-[#141210] rounded-2xl p-6 sm:p-8 shadow-xl">
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-28 w-full">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-red-500"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-red-600">ANOMALIE_NIF_ACHAT</div>
                <div className="text-[13px] text-gray-600">NIF fournisseur absent — TVA déductible rejetée</div>
              </div>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-red-500"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-red-600">ANOMALIE_RC_ACHAT</div>
                <div className="text-[13px] text-gray-600">RC fournisseur absent — TVA déductible rejetée</div>
              </div>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-orange-500"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-orange-600">ANOMALIE_ART_ACHAT</div>
                <div className="text-[13px] text-gray-600">Article d'imposition absent — déductibilité risquée</div>
              </div>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-orange-500"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-orange-600">ANOMALIE_ADRESSE_ACHAT</div>
                <div className="text-[13px] text-gray-600">Adresse fournisseur manquante</div>
              </div>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-yellow-500"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-yellow-700">ANOMALIE_MODE_PAIEMENT_VENTE</div>
                <div className="text-[13px] text-gray-600">Mode de paiement non renseigné</div>
              </div>
            </div>
            <div className="rounded-xl border border-gray-100 p-4 sm:p-5 bg-white hover:shadow-md transition-shadow duration-200 flex items-start gap-3">
              <div className="w-2 h-2 rounded-full flex-shrink-0 mt-1.5 bg-red-700"></div>
              <div>
                <div className="text-[11px] font-mono font-medium mb-1 text-red-800">ANOMALIE_ESPECE_VENTE</div>
                <div className="text-[13px] text-gray-600">Paiement espèces {'>'} 1.000.000 DA — infraction légale</div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#F4F3EF] py-16 sm:py-20 lg:py-24 w-full">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            {/* FR Card */}
            <div className="bg-white rounded-2xl p-5 sm:p-6 flex-1 shadow-sm">
            ...
            {/* AR Card */}
            <div className="bg-[#141210] rounded-2xl p-5 sm:p-6 flex-1 shadow-xl flex flex-col">
      ...
      <section className="bg-[#141210] py-16 sm:py-20 lg:py-24 w-full">
        <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div className="bg-[#1A6B5E]/20 rounded-2xl p-6 border border-[#1A6B5E]/30 relative overflow-hidden">
